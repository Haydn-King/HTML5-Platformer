...
class Game extends Phaser.Scene {
  ...
  addHero() {
    ...
    this.children.moveTo(
      this.hero,
      this.children.getIndex(
        this.map.getLayer("Foreground").tilemapLayer
      )
    );
  ...
  addMap() {
    ...
    const groundLayer = this.map.createStaticLayer(
      "Ground",
      groundTiles
    );
